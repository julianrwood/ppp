...
megascans_img = ImageTk.PhotoImage(Image.open("F:\\Julian\\Pipeline\\context_creator\\icons\\megascans\\icon.png"))
...
list_of_maya_files = glob.glob("F:/Julian/Pipeline/templates/maya/*")
...
list_of_nuke_files = glob.glob("F:/Julian/Pipeline/templates/nuke/*")
...
def set_context():
    context_file = open("F:\Julian\Pipeline\config\Context\context.txt", "w")
